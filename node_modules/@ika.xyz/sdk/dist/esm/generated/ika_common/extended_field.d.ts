...
export declare const ExtendedField: MoveStruct<{
    id: BcsType<string, string | Uint8Array<ArrayBufferLike>, "bytes[32]">;
}, "@local-pkg/common::extended_field::ExtendedField<phantom T>">;
export declare const Key: MoveTuple<readonly [BcsType<boolean, boolean, "bool">], "@local-pkg/common::extended_field::Key">;
