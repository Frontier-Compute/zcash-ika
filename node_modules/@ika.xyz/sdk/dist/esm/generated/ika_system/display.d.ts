...
export declare const ObjectDisplay: MoveStruct<{
...
}, "@local-pkg/system::display::ObjectDisplay">;
export declare const PublisherKey: MoveTuple<readonly [import("@mysten/bcs").BcsType<boolean, boolean, "bool">], "@local-pkg/system::display::PublisherKey">;
