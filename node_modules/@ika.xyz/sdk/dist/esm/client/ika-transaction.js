...
createUserSignMessageWithPublicOutput_fn = async function({
  ...
  const { curveNumber, signatureAlgorithmNumber, hashNumber } = fromCurveAndSignatureAlgorithmAndHashToNumbers(curve, signatureScheme, hash);
...
assertCanRunNormalPresign_fn = function(dWallet, signatureAlgorithm) {
  if (dWallet.is_imported_key_dwallet && (signatureAlgorithm === SignatureAlgorithm.ECDSASecp256k1 || signatureAlgorithm === SignatureAlgorithm.ECDSASecp256r1)) {
    return;
  }
