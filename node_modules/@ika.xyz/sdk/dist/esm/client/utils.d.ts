 ...
 */
export declare function objResToBcs(resp: SuiClientTypes.Object<{
    content: true;
}> | SuiClientTypes.GetObjectResponse<{
    content: true;
}> | Error): Uint8Array<ArrayBuffer>;
export declare function fetchAllDynamicFields(suiClient: ClientWithCoreApi, parentId: string): Promise<SuiClientTypes.DynamicFieldEntry[]>;
/**
 ...
 */
export declare function encodeToASCII(input: string): Uint8Array;
/**
 ...
 */
export declare function u64ToBytesBigEndian(value: number | bigint): Uint8Array;
/**
